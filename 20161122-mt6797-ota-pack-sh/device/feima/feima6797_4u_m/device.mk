...
include device/feima/$(MTK_TARGET_PROJECT)/ProjectConfig.mk

# PRODUCT_COPY_FILES += device/feima/feima6797_4u_m/egl.cfg:system/lib/egl/egl.cfg
# PRODUCT_COPY_FILES += device/feima/feima6797_4u_m/ueventd.mt6797.rc:root/ueventd.mt6797.rc

PRODUCT_COPY_FILES += device/feima/feima6797_4u_m/factory_init.project.rc:root/factory_init.project.rc
PRODUCT_COPY_FILES += device/feima/feima6797_4u_m/init.project.rc:root/init.project.rc
PRODUCT_COPY_FILES += device/feima/feima6797_4u_m/meta_init.project.rc:root/meta_init.project.rc

ifeq ($(MTK_SMARTBOOK_SUPPORT),yes)
PRODUCT_COPY_FILES += device/feima/feima6797_4u_m/sbk-kpd.kl:system/usr/keylayout/sbk-kpd.kl \
                      device/feima/feima6797_4u_m/sbk-kpd.kcm:system/usr/keychars/sbk-kpd.kcm
endif

# Add FlashTool needed files
#PRODUCT_COPY_FILES += device/feima/$(MTK_TARGET_PROJECT)/EBR1:EBR1
#ifneq ($(wildcard device/feima/$(MTK_TARGET_PROJECT)/EBR2),)
#  PRODUCT_COPY_FILES += device/feima/$(MTK_TARGET_PROJECT)/EBR2:EBR2
#endif
#PRODUCT_COPY_FILES += device/feima/$(MTK_TARGET_PROJECT)/MBR:MBR
#PRODUCT_COPY_FILES += device/feima/$(MTK_TARGET_PROJECT)/MT6797_Android_scatter.txt:MT6797_Android_scatter.txt
...
PRODUCT_COPY_FILES += device/feima/feima6797_4u_m/android.hardware.telephony.gsm.xml:system/etc/permissions/android.hardware.telephony.gsm.xml
...
ifneq ($(strip $(HUBA_RELEASE_VERSION)),)
PRODUCT_PROPERTY_OVERRIDES += ro.huba.version.release=$(strip $(HUBA_RELEASE_VERSION))
else
PRODUCT_PROPERTY_OVERRIDES += ro.huba.version.release=V0.0.0
endif
...
PRODUCT_COPY_FILES += vendor/mediatek/proprietary/custom/feima6797_4u_m/factory/res/sound/testpattern1.wav:system/res/sound/testpattern1.wav
PRODUCT_COPY_FILES += vendor/mediatek/proprietary/custom/feima6797_4u_m/factory/res/sound/ringtone.wav:system/res/sound/ringtone.wav

# Keyboard layout
PRODUCT_COPY_FILES += device/mediatek/mt6797/ACCDET.kl:system/usr/keylayout/ACCDET.kl
PRODUCT_COPY_FILES += device/feima/feima6797_4u_m/mtk-kpd.kl:system/usr/keylayout/mtk-kpd.kl

# Microphone
PRODUCT_COPY_FILES += device/feima/feima6797_4u_m/android.hardware.microphone.xml:system/etc/permissions/android.hardware.microphone.xml

# Camera
PRODUCT_COPY_FILES += device/feima/feima6797_4u_m/android.hardware.camera.xml:system/etc/permissions/android.hardware.camera.xml

# Audio Policy
PRODUCT_COPY_FILES += device/feima/feima6797_4u_m/audio_policy.conf:system/etc/audio_policy.conf


#Images for LCD test in factory mode
PRODUCT_COPY_FILES += vendor/mediatek/proprietary/custom/feima6797_4u_m/factory/res/images/lcd_test_00.png:system/res/images/lcd_test_00.png
PRODUCT_COPY_FILES += vendor/mediatek/proprietary/custom/feima6797_4u_m/factory/res/images/lcd_test_01.png:system/res/images/lcd_test_01.png
PRODUCT_COPY_FILES += vendor/mediatek/proprietary/custom/feima6797_4u_m/factory/res/images/lcd_test_02.png:system/res/images/lcd_test_02.png
...
DEVICE_PACKAGE_OVERLAYS += device/feima/feima6797_4u_m/overlay
...
# huba apk & conf
PRODUCT_PACKAGES += FMHuba FMVoice #zhangdp
PRODUCT_COPY_FILES += device/feima/feima6797_4u_m/dnsmasq.more.conf:system/etc/dnsmasq.more.conf

# inherit mt6797 platform
$(call inherit-product, device/mediatek/mt6797/device.mk)

$(call inherit-product-if-exists, vendor/feima/libs/$(MTK_TARGET_PROJECT)/device-vendor.mk)
