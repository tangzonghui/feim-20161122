...
$(call inherit-product, device/feima/$(MTK_TARGET_PROJECT)/device.mk)
...
PRODUCT_NAME := full_feima6797_4u_m
PRODUCT_DEVICE := feima6797_4u_m
PRODUCT_MODEL := feima6797_4u_m
PRODUCT_POLICY := android.policy_phone
#kame_li, MTP info
PRODUCT_BRAND := feimarobotics#alps

ifeq ($(TARGET_BUILD_VARIANT), eng)
KERNEL_DEFCONFIG ?= feima6797_4u_m_debug_defconfig
else
KERNEL_DEFCONFIG ?= feima6797_4u_m_defconfig
endif
PRELOADER_TARGET_PRODUCT ?= feima6797_4u_m
LK_PROJECT ?= feima6797_4u_m
TRUSTY_PROJECT ?= feima6797_4u_m
