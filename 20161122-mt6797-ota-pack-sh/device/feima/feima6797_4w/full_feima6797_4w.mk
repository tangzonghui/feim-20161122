...
PRODUCT_NAME := full_feima6797_4w
PRODUCT_DEVICE := feima6797_4w
PRODUCT_MODEL := feima6797_4w
PRODUCT_POLICY := android.policy_phone
PRODUCT_BRAND := alps

ifeq ($(TARGET_BUILD_VARIANT), eng)
KERNEL_DEFCONFIG ?= feima6797_4w_debug_defconfig
else
KERNEL_DEFCONFIG ?= feima6797_4w_defconfig
endif
PRELOADER_TARGET_PRODUCT ?= feima6797_4w
LK_PROJECT ?= feima6797_4w
TRUSTY_PROJECT ?= feima6797_4w
