...
#kame_li, MTP info
PRODUCT_BRAND := feimarobotics#alps
PRODUCT_MANUFACTURER := feimarobotics#alps
...
ifneq ($(MTK_AUDIO_TUNING_TOOL_VERSION),)
  ifneq ($(strip $(MTK_AUDIO_TUNING_TOOL_VERSION)),V1)
	...
	AUDIO_PARAM_OPTIONS_LIST += SPK_PATH_INT=no 
...
#for supersensor model
PRODUCT_PACKAGES += blackbox
PRODUCT_PACKAGES += gimbalserver
PRODUCT_PACKAGES += groundudpserver
PRODUCT_PACKAGES += meta_gpio_test
PRODUCT_PACKAGES += hubamain
PRODUCT_PACKAGES += voiceudpserver
PRODUCT_PACKAGES += tcpcli
PRODUCT_PACKAGES += hubabattery
PRODUCT_PACKAGES += hubagps
PRODUCT_PACKAGES += hubawprod

#for supersensor opencv
PRODUCT_PACKAGES += libopencv_calib3d
PRODUCT_PACKAGES += libopencv_features2d
PRODUCT_PACKAGES += libopencv_flann
PRODUCT_PACKAGES += libopencv_hal
PRODUCT_PACKAGES += libopencv_ts
PRODUCT_PACKAGES += libopencv_imgproc
PRODUCT_PACKAGES += libopencv_ml
PRODUCT_PACKAGES += libopencv_objdetect
PRODUCT_PACKAGES += libopencv_photo
PRODUCT_PACKAGES += libopencv_shape
PRODUCT_PACKAGES += libopencv_stitching
PRODUCT_PACKAGES += libopencv_superres
PRODUCT_PACKAGES += libopencv_video
PRODUCT_PACKAGES += libopencv_videoio
PRODUCT_PACKAGES += libopencv_videostab
PRODUCT_PACKAGES += libopencv_core
PRODUCT_PACKAGES += libopencv_highgui
PRODUCT_PACKAGES += libopencv_imgcodecs
PRODUCT_PACKAGES += gnustl_static
PRODUCT_PACKAGES += supc++
PRODUCT_PACKAGES += c++_static
PRODUCT_PACKAGES += stlport_static

#for wifi stream
PRODUCT_PACKAGES += libLiveStreaming

#for model
PRODUCT_PACKAGES += libiniparser
PRODUCT_PACKAGES += libTracker
PRODUCT_PACKAGES += libthread_util
PRODUCT_PACKAGES += libmsc

#for supersensor cfg
PRODUCT_COPY_FILES += vendor/supersensor/cfg/blackbox/blackbox.ini:data/supersensor/blackbox/blackbox.ini
PRODUCT_COPY_FILES += vendor/supersensor/cfg/sonar/sonar.ini:/data/supersensor/sonar/sonar.ini
PRODUCT_COPY_FILES += vendor/supersensor/cfg/fmgps/fmgps.ini:/data/supersensor/fmgps/fmgps.ini
PRODUCT_COPY_FILES += vendor/supersensor/cfg/gimbal/gimbal.ini:data/supersensor/gimbal/gimbal.ini
PRODUCT_COPY_FILES += vendor/supersensor/cfg/tracker/parameters.yml:data/parameters.yml
PRODUCT_COPY_FILES += vendor/supersensor/cfg/systeminfo/systeminfo.ini:data/supersensor/systeminfo/systeminfo.ini

#xlog_off
PRODUCT_COPY_FILES += $(LOCAL_PATH)/xlog_off.sh:system/etc/xlog_off.sh
PRODUCT_COPY_FILES += $(LOCAL_PATH)/xlog_off.sh:system/bin/xlog_off.sh

#close wdt 
PRODUCT_COPY_FILES += $(LOCAL_PATH)/close_wdt.sh:system/bin/close_wdt.sh
